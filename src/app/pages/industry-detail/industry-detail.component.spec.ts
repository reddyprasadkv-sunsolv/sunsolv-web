...
describe('IndustryDetailComponent', () => {
  ...
  it('publishes Healthcare through lazy industry data without unfinished industry routes', () => {
    ...
    expect(industryDetailPaths).toEqual(['industries/healthcare']);
    expect(publicPaths).toHaveLength(18);
  ...
  it('links only Healthcare from the approved Industries Overview and preserves service routes', async () => {
    const fixture = TestBed.createComponent(App);
    fixture.detectChanges();
